...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-pattern py-4 sm:py-8 px-3 sm:px-6">
      <div className="max-w-4xl mx-auto glass-card p-4 sm:p-6 rounded-2xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-3 mb-6">
            <TabsTrigger value="home" className="flex items-center gap-1 sm:gap-2 px-2 sm:px-4">
              <Home className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
              <span className={isMobile ? "text-xs" : ""}>Home</span>
            </TabsTrigger>
            <TabsTrigger value="chat" className="flex items-center gap-1 sm:gap-2 px-2 sm:px-4">
          ...
          <TabsContent value="home" className="space-y-4 sm:space-y-6">
            <div className="bg-white/10 p-4 sm:p-6 rounded-lg">
              <h2 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4">Welcome Home</h2>
              <p className="mb-3 sm:mb-4 text-sm sm:text-base">This is your dashboard home. You can access all your important information from here.</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                <div className="bg-white/5 p-3 sm:p-4 rounded-md">
                  <h3 className="font-medium mb-2 text-sm sm:text-base">Quick Stats</h3>
                  <p className="text-xs sm:text-sm">Your account information and statistics will appear here.</p>
                </div>
                <div className="bg-white/5 p-3 sm:p-4 rounded-md">
                  <h3 className="font-medium mb-2 text-sm sm:text-base">Recent Activity</h3>
          ...
          <TabsContent value="profile" className="space-y-4 sm:space-y-6">
            <div className="bg-white/10 p-4 sm:p-6 rounded-lg">
              ...
              <p className="mb-3 sm:mb-4 text-sm sm:text-base">Manage your account settings and profile information.</p>
              
              <div className="bg-white/5 p-3 sm:p-4 rounded-md mb-3 sm:mb-4">
